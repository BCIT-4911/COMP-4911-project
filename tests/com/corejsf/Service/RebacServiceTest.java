...
public class RebacServiceTest {
    ...
    @Test
    void operationsManagerCannotManageEmployees() {
        assertFalse(rebacService.canManageEmployees(SystemRole.OPERATIONS_MANAGER));
    }

    @Test
    void employeeCannotManageEmployees() {
        assertFalse(rebacService.canManageEmployees(SystemRole.EMPLOYEE));
    }
    ...
    @Test 
    void employeeObjectCannotManageEmployeeWhenSetToOperationsManager() {
        Employee emp = new Employee();
        emp.setSystemRole(SystemRole.OPERATIONS_MANAGER);
        assertFalse(rebacService.canManageEmployees(emp));
    }
